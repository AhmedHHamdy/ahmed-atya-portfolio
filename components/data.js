...
export const logos = ["/assets/logo1.png", "/assets/logo2.png", "/assets/logo3.png"];
...
export const services = [
  {
    number: "01",
    title: "UI APPS",
    tags: ["iOS & Android Interfaces", "UX Research", "Wireframing & Prototyping", "User Flow Mapping"],
  },
  {
    number: "02",
    title: "UI WEBSITES",
    tags: ["Responsive", "Website UI Strategy", "Information Architecture", "Landing Page"],
  },
  {
    number: "03",
    title: "UI DASHBOARDS",
    tags: ["SaaS Dashboard", "Admin Panel UI", "Analytics Interface", "Complex System UX"],
  },
  {
    number: "04",
    title: "DESIGN SYSTEM",
    tags: ["Design Tokens", "UI Component Library", "Scalable Design Systems", "Style Guidelines"],
  },
  {
    number: "05",
    title: "2D ANIMATION",
    tags: ["Logo Animation", "UI Motion Design", "Animated Onboarding", "Micro-Interactions"],
  },
];
